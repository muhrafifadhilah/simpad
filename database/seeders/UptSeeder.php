...
class UptSeeder extends Seeder
{
    public function run()
    {
        $uptList = [
            [
                'no' => 1,
                'nama' => 'UPT Pajak Wilayah Cibinong',
            ...
            [
                'no' => 2,
                'nama' => 'UPT Pajak Wilayah Cileungsi',
            ...
            [
                'no' => 4,
                'nama' => 'UPT Pajak Wilayah Leuwiliang',
            ...
            [
                'no' => 6,
                'nama' => 'UPT Pajak Wilayah Cigudeg',
            ...
            [
                'no' => 7,
                'nama' => 'UPT Pajak Wilayah Jonggol',
            ...
            [
                'no' => 8,
                'nama' => 'UPT Pajak Wilayah Cisarua',
