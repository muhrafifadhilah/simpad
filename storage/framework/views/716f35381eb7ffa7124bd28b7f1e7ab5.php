                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="dasar" class="form-control" value="<?php echo e($sptpd->dasar); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="tarif" class="form-control" value="<?php echo e($sptpd->tarif); ?>" step="0.001">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="omset_tapping_box" class="form-control" value="<?php echo e($sptpd->omset_tapping_box); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="pajak_terutang" class="form-control" value="<?php echo e($sptpd->pajak_terutang); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="denda" class="form-control" value="<?php echo e($sptpd->denda); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                <i class="fas fa-percentage"></i>
                                <input type="number" name="bunga" class="form-control" value="<?php echo e($sptpd->bunga); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="setoran" class="form-control" value="<?php echo e($sptpd->setoran); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="kenaikan" class="form-control" value="<?php echo e($sptpd->kenaikan); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="kompensasi" class="form-control" value="<?php echo e($sptpd->kompensasi); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="number" name="lain_lain" class="form-control" value="<?php echo e($sptpd->lain_lain); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
                </div>
