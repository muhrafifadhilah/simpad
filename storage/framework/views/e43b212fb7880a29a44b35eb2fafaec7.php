...
<div class="main-content-wrapper">
    <div class="container-fluid">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-number"><?php echo e(count($wajibPajak)); ?></div>
                <div class="stat-label">Total Wajib Pajak</div>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?php echo e($wajibPajak->where('disabled', 0)->count()); ?></div>
                <div class="stat-label">Aktif</div>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?php echo e($wajibPajak->where('disabled', 1)->count()); ?></div>
        ...
        <div class="modern-controls-container">
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('wp.create')); ?>" class="btn-modern btn-add">
        ...
        <div class="modern-table-container">
            <table class="modern-table" id="wpTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $wajibPajak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($wp->user->userid ?? ''); ?></td>
                        <td><?php echo e($wp->name); ?></td>
                        <td><?php echo e($wp->user->created_at ? $wp->user->created_at->format('d-m-Y') : ''); ?></td>
                        <td>
                            <span class="status-badge <?php echo e($wp->disabled ? 'status-disabled' : 'status-active'); ?>">
                                <?php echo e($wp->disabled ? 'Non-Aktif' : 'Aktif'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\simpad\resources\views/wp/index.blade.php ENDPATH**/ ?>