                ...
                <div class="control-group">
                    ...
                    <select id="filterSubjek" class="modern-select">
                        ...
                        <?php $__currentLoopData = $subjekList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subjek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($subjek->id); ?>"><?php echo e($subjek->subjek_pajak); ?> (<?php echo e($subjek->npwpd); ?>)</option>
...
$(function() {
    ...
    let table = $('#objekTable').DataTable({
        ...
        ajax: {
            url: '<?php echo e(route('objek_pajak.index')); ?>',
            data: function(d) {
    ...
    $('#deleteObjekBtn').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(url('objek_pajak')); ?>/" + selectedRowId,
                    type: 'DELETE',
    ...
    $('#objekForm').submit(function(e) {
        ...
        let url, type;
        if (id) {
            url = "<?php echo e(url('objek_pajak')); ?>/" + id;
            type = 'PUT';
        } else {
            url = "<?php echo e(route('objek_pajak.store')); ?>";
            type = 'POST';
        }
        $.ajax({
            url: url,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simpad new\simpad\resources\views/objek_pajak/index.blade.php ENDPATH**/ ?>