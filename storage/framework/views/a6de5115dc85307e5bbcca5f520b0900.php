...
<body>
    ...
    <div class="sptpd-info">
        ...
        <div class="info-row">
            ...
            <div class="info-colon">:</div>
            <div class="info-value"><?php echo e($sptpd->created_at->format('d F Y')); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Jatuh Tempo</div>
            <div class="info-colon">:</div>
            <div class="info-value fw-bold"><?php echo e(\Carbon\Carbon::parse($sptpd->jatuh_tempo)->format('d F Y')); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Status</div>
            <div class="info-colon">:</div>
            <div class="info-value"><?php echo e($sptpd->status); ?></div>
        </div>
    </div>
    ...
    <div class="wp-data">
        ...
        <table class="wp-table">
            <tr>
                ...
                <td><?php echo e($sptpd->objekPajak->objek_pajak ?? 'Pajak Umum'); ?></td>
            </tr>
            <tr>
    ...
    <div class="notes">
        ...
        <ol>
            ...
            <li>Pembayaran dilakukan paling lambat tanggal <?php echo e(\Carbon\Carbon::parse($sptpd->jatuh_tempo)->format('d F Y')); ?></li>
...
<?php /**PATH C:\laragon\www\simpad new\simpad\resources\views/wp/sptpd_pdf.blade.php ENDPATH**/ ?>