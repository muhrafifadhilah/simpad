                ...
                <div class="card-body text-white">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e($sptpd->count()); ?></h3>
                        </div>
                ...
                <div class="card-body text-white">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e($sptpd->where('status', '!=', 'Lunas')->count()); ?></h3>
                        </div>
                ...
                <div class="card-body text-white">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0">Rp <?php echo e(number_format($sptpd->sum('pajak_terutang'), 0, ',', '.')); ?></h3>
                        </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <?php if($item->jatuh_tempo): ?>
                                        ...
                                        <?php if($isOverdue): ?>
                                            <br><small class="text-danger">Terlambat <?php echo e($jatuhTempo->diffForHumans()); ?></small>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <span class="text-muted">-</span>
                                    <?php endif; ?>
                                ...
                                <td class="align-middle">
                                    <strong class="text-success">
                                        Rp <?php echo e(number_format($item->pajak_terutang ?? 0, 0, ',', '.')); ?>
                                ...
                                <td class="align-middle text-center">
                                    <div class="btn-group" role="group">
                                        <button class="btn btn-sm btn-outline-primary" title="Lihat Detail" onclick="viewDetail(<?php echo e($item->id); ?>)">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <?php if($item->status != 'Lunas'): ?>
                                            <button class="btn btn-sm btn-outline-success" title="Bayar" onclick="bayarSptpd(<?php echo e($item->id); ?>)">
                                                <i class="fas fa-credit-card"></i>
                                            </button>
                                        <?php endif; ?>
                                        <?php if($item->status == 'Lunas'): ?>
                                            <button class="btn btn-sm btn-outline-secondary" title="Bukti Bayar" onclick="buktiBayar(<?php echo e($item->id); ?>)">
                                                <i class="fas fa-receipt"></i>
                                            </button>
                                        <?php endif; ?>
                                        <button class="btn btn-sm btn-outline-info" title="Cetak PDF" onclick="printPdf(<?php echo e($item->id); ?>)">
                ...
                <form id="createSptpdForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="objek_pajak_id" required>
                            ...
                            <?php if(isset($objekPajaks) && $objekPajaks->count() > 0): ?>
                                <?php $__currentLoopData = $objekPajaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($objek->id); ?>"><?php echo e($objek->jenis_pajak); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
