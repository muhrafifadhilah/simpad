            ...
            <div class="col-md-12">
                ...
                <div class="modern-controls-container mb-4">
                    <div class="controls-grid">
                        ...
                        <div class="control-group">
                            <label for="filterObjekPajak" class="modern-label">
                                <i class="fas fa-building me-2"></i>Filter Jenis Pajak
                            </label>
                                            ...
                                            <tr class="table-row-modern">
                                                ...
                                                <td class="text-start">
                                                    <div class="cell-content">
                                                        <strong><?php echo e($item->generated_nomor_sptpd); ?></strong>
                                                    </div>
                                                </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info">
                    ...
                    <strong>Informasi:</strong> Pastikan pembayaran telah dilakukan sebelum konfirmasi.
                </div>
...
document.getElementById('filterObjekPajak').addEventListener('change', filterTable);
...
.stat-card-modern.danger-gradient {
