...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'SIMPAD - Sistem Informasi Manajemen Pajak Daerah')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Sistem Informasi Keuangan Daerah">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="{{ asset('assets/img/semut.svg') }}">
    <link rel="icon" type="image/png" href="{{ asset('assets/img/semut-pemda.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('assets/img/semut-pemda.png') }}">
